    ...
    public class TokenHandler
    {
        ...
        public Token CreateAccessToken(User user)
        {
            ...
            JwtSecurityToken securityToken = new JwtSecurityToken(
                issuer: Configuration["Token:Issuer"], //olusturulan token değerini kimlerin yada hangi orjinlerin yada hangi sitelerin kullanacağını
                audience: Configuration["Token:Audience"], //Olusturulan token degeri kimin tarafından olusturulacağını verir
